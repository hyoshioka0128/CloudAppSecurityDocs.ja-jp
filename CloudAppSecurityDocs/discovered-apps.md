...
2. 次に、詳細フィルターを使用して、 **[コンプライアンス リスク要因]** の **[SOC 2]** を **[False]** に設定します。
3. **[使用状況]** については、 **[ユーザー]** を 50 ユーザーより多くなるように設定します。さらに **[使用状況]** を、 **[トランザクション]** を 100 より多くなるように設定します。
4. **[セキュリティ リスク要因]** については、 **[保存データの暗号化]** を **[サポートされていません]** に設定します。 次に、 **[リスク スコア]** を 6 以下に設定します。

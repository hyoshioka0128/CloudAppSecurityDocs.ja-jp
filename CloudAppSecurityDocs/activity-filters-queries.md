...
- アクティビティ ID - ID を使用して特定のアクティビティのみを検索します。 このフィルターは、(SIEM エージェントを使用して) Microsoft Cloud App Security を SIEM に接続する場合や、Cloud App Security ポータル内でアラートをさらに詳細に調査する場合にとても便利です。  

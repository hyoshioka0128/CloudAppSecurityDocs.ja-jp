...
ms.locfileid: "81662207"
---
# <a name="connect-apps"></a>アプリの接続
...
| **ユーザー ガバナンス** | | ✔ | 近日対応予定 | サブジェクト G Suite 接続 | ✔ | ✔ | | 近日対応予定 | ✔ | 近日対応予定 | プロバイダーはサポートしていません |
| **ログオン アクティビティ** | ✔ | ✔ | ✔ | サブジェクト G Suite 接続 | ✔ | ✔ | ✔ | ✔ | ✔ | ✔ | ✔ |
| **ユーザーアクティビティ** | 適用なし | ✔ | ✔ | ✔ | ✔ - Google の Business または Enterprise が必要 | ✔ | ✔ | Partial | Salesforce Shield でサポート | ✔ | ✔ |
| **管理者アクティビティ** | ✔ | ✔ | ✔ | ✔ | ✔ | ✔ | ✔ | Partial | ✔ | ✔ | プロバイダーはサポートしていません |
| **DLP-定期スキャン** | | ✔ | 近日対応予定 | 適用なし | ✔ | ✔ | 適用なし | | | | プロバイダーはサポートしていません |
| **DLP-ほぼリアルタイムのスキャン** | | ✔ | ✔ | 適用なし | ✔-Google Business Enterprise が必要です | ✔ | 適用なし | ✔ | ✔ | ✔ | プロバイダーはサポートしていません |
| **共有制御** | ✔ | ✔ | ✔ | 適用なし | ✔ | ✔ | 適用なし | 適用なし | | ✔ | プロバイダーはサポートしていません |

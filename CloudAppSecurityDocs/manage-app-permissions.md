...
|アプリ|アプリの名前。 名前を選択すると、説明、発行者 (Office 365 の場合)、アプリの Web サイト、ID などを含む詳細が表示されます。|Office 365、G Suite、Salesforce|
...
|Publisher|アプリを提供するベンダーの名前。|Office 365|
...
1. **[OAuth アプリ]** ページで、アプリをクリックして**アプリ ドロワー**を開き、アプリと付与されているアクセス許可に関する詳細情報を表示します。
    ...
    - アプリに付与されたアクセス許可の完全な一覧を表示するには、[**アクセス許可**] をクリックします。
    - [**コミュニティ**での使用] では、他の組織におけるアプリの共通点を確認できます。
    - [**関連アクティビティ**] をクリックすると、このアプリに関連するアクティビティログに表示されるアクティビティが表示されます。
...
- フィルターを追加するには、[**フィルターの追加**] アイコンをクリックして、クエリをさらに絞り込むためのフィルターを追加します。 フィルターは自動的に適用され、アプリの一覧が更新されます。
...
組織で検出された OAuth アプリが悪意があると思われる場合は、Cloud App Security チームのフィードバックを送信してお知らせください。 この機能を使用すると、セキュリティ コミュニティの一員となって、OAuth アプリのリスク スコアと分析を強化できます。

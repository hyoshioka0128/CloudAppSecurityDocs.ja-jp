...
- [アクティビティ ログ](activity-filters.md)と[ファイル ログ](file-filters.md)のフィルター処理を簡略化するために、類似するフィルターが統合されました。 アクティビティ フィルターは、アクティビティ オブジェクト、IP アドレス、ユーザーに使用します。 対象を厳密に検索するには、[コラボレーター] ファイル フィルターを使用します。
